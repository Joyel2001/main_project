...
path('custom_login/', user_loginnn, name='custom_login'),
...
path('approve/', approve_application, name='approve_application'),
    ...
    path('delete_item/', delete_item, name='delete_item'),
     ...
     path('wishlist/', wishlists, name='wishlist'),
      ...
      path('redeem_store_view/', redeem_store_view, name='redeem_store_view'),
      path('redeem_detail/<int:product_id>/', redeem_detail, name='redeem_detail'),
   path('order_page/', views.order_page, name='order_page'),
    path('order/<int:order_id>/', order_detail, name='order_detail'),
    path('submit_review/', views.submit_review, name='submit_review'),
    path('collection_request_form/', collection_request_form, name='collection_request_form'),
    path('recyclable_details/', collection_request_list, name='recyclable_details'),
    #  path('api/feedback/', feedback_list, name='feedback-list'),
